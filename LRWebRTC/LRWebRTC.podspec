Pod::Spec.new do |s|
  ...
  s.source_files        = 'LRWebRTC/WebRTC.framework/Headers/**/*.h'
  s.public_header_files = 'LRWebRTC/WebRTC.framework/Headers/**/*.h' 
  s.vendored_frameworks = 'LRWebRTC/WebRTC.framework'
